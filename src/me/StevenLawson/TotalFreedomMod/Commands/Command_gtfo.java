...
@CommandParameters(description = "Someone Breaking The Rules? Use:", usage = "/<command> <partialname>")
public class Command_gtfo extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(player.getName() + " has been very unloyal, goodbye!", ChatColor.RED);
        ...
        // kick Player:
        player.kickPlayer(ChatColor.RED + "Kicked From JelloFreedom" + (reason != null ? ("\nReason: " + ChatColor.YELLOW + reason) : ""));
